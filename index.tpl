...
<script>
	...
	var disqus_config = function () {
		this.page.url = "https://jvm-argument-for-docker.teaho.net";  // Replace PAGE_URL with your page's canonical URL variable
		this.page.identifier = "jvm-argument-for-docker.teaho.net"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
	};
